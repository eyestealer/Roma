...
<!-- ADD THE CLASS layout-boxed TO GET A BOXED LAYOUT -->
    <body class="hold-transition skin-blue layout-boxed sidebar-mini">
        ...
        <div class="wrapper">
            <!-- Inicio Header -->
            @include("theme/$theme/header") <!-- Llama al HEADER.blade -->
            <!-- Fin Header -->
            <!-- Inicio Aside -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                        ...
                        <!-- Default box -->
                         <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Ferretería Roma</h3>
                        ...
                        <div class="box-body">
                            Aguanten las lolis. Y ella ->
                            <img src="{{asset("assets/$theme/dist/img/nierpat.jpg")}}" class="img-circle" alt="User Image">
